...
![Skills](https://img.shields.io/badge/skills-51-2EA44F)
...
flowchart LR
    ...
    subgraph ONDEMAND["Loaded on demand"]
        SK["51 skills<br/>.claude/skills/*"] --> REF["references/*<br/>templates, sources & deep-dive docs"]
...
│   ├── skills/                     # 📚 51 skills, FLAT — auto-discovered & matched by description (catalog below)
